    ...
    <Center>
      <mesh ref={meshRef} geometry={geometry} castShadow receiveShadow>
        <meshStandardMaterial 
          ...
          roughness={0.7} 
          metalness={0.2}
          // @ts-ignore - Types from react-three-fiber don't match exactly with THREE.js
        />
      </mesh>
    </Center>
  )
  ...
  return (
    <div className="relative h-full flex flex-col">
      <div className="absolute top-0 right-0 z-20 p-2">
        <Button variant="outline" size="sm" className="bg-white shadow-md" onClick={handleDownload}>
      ...
      <div className="flex-1 min-h-[400px] bg-gray-100 rounded-md overflow-hidden">
        {imageUrl ? (
          <Canvas shadows camera={{ position: [0, 0, 2], fov: 50 }}>
            ...
            {/* Fix the Stage component props - remove contactShadow and shadows */}
      ...
      <div className="mt-4 flex justify-center">
        <div className="flex bg-gray-100 p-1 rounded-md shadow-sm z-10 relative">
          <Button
